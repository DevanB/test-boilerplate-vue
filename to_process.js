...
/*
  Description:  Place all custom jquery and javascript code for the theme here.
  Author:       Joshua Gilmer
  Version:      1.2.1
  Demo:         http://codepen.io/infojosh/pen/bdmWrg
...
(function($){var $ = require('jquery');var spacetime;var odd = 0;$(document).ready(function(){function init(){$('*').unbind('.luckie');if($('.mobile-view').is(':visible')){
...
if (once) {
  ...
  if ( $('.triumeq.hcp').length ) {
    $('.main-column').before('<div class="header-offset"></div>');
...
$('#header').removeClass('show-nav').removeClass('minimal');
...
$('.header-pad').css('height','');
$('.header-pad').css('height', $('.bar-util').outerHeight() + $('#header .logo').outerHeight() + 12);
var headerHeight = $('.header-pad').outerHeight(true);
$('.first-section').css('padding-top', $('#header').height() + 12);
...
// Equalizing caption heights under graph charts
$(function() {
  $('.homepage-button').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$('.cta-section').css('margin-top','');

if( $('.triumeq.hcp').length ) {
  $('.header-offset').css('height', $('#header').height()).css('display','block');
  $('.header-off').css('height',$('#header').height() + 10).css('display','block');
}
$('.match').css('height','');
$('#clinical-resistance-results .col--one-half > p:first-child').css('height','');
...
$('img[data-width]').each(function(){
  var $this = $(this);
  $this.css('min-height', $this.parents('.col--one-half').find('img').width() * ($this.attr('data-height') / $this.attr('data-width')) );
});

// Creating a resize end timeout listener
...
$(window).on('resize.luckie',function() {
  var resetHeaderOff = false;
  if( $('.header-off').css('display') == 'block') {
    $('.header-off').hide();
    resetHeaderOff = true;
  }
  // Stop CTA button resize animation on resize
  $('.homepage-button').addClass('halt-animation');
});

// Restart CTA button resize animation after resize
$(window).bind('resizeEnd',function() {
  $('.homepage-button').removeClass('halt-animation');
});
...
$('.first-section').css('margin-top', '0').css('padding-top','');
...
if($('.homepage-button').length) {
  fixHomePageButtons();
}

function fixHomePageButtons() {
  var tallestHeight = 0;
  $('.homepage-button').css('height','');
  $('.homepage-button').each(function(index, el) {
    var initHeight = $(this).height() + 18;
    $(this).attr('style','');
    if ($(this).height() > tallestHeight) {
      tallestHeight = $(this).height() + 18;
    }
    else
    {
  ...
  $('.homepage-button').height(tallestHeight);
}
...
var storeHeight = 0;
$('.homepage-button').on('mouseenter.luckie', function(){
  storeHeight = $(this).outerHeight();
  $(this).attr('style', '');
});

$('.homepage-button').on('mouseleave.luckie', function(){
  $(this).css('height',storeHeight);
});
...
$(function(){
  $('.col--one-half .match').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$(function(){
  $('#clinical-trial-designs h3').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$(function(){
  $('#clinical-virologic-response h3').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$(function(){
  $('#clinical-resistance-results h3').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$(function(){
  $('#clinical-resistance-results .match-1').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$(function(){
  $('#clinical-resistance-results .match-2').matchHeight({
    byRow: true,
    property: 'height',
    target: null,
    remove: false
...
$(function(){
  $('.page-section .col--one-half').matchHeight({
    byRow:true,
    property: 'height',
    target: null,
    remove: false
...
// Unslick existing versions
if($('.efficacy .slick-initialized').length) {
  $('.efficacy .slick').slick('unslick');
}

//----- END of NON-MOBILE CODE -----//
}
...
$('.triumeq-cta, .homepage-button').on('click.luckie',function() {
...
/* ==========================================================================
   ...
   ========================================================================== */
/* --------------------------------------------------------------------------
    4.a TABLET PORTRAIT CODE - Uncomment below if ever needed
   -------------------------------------------------------------------------- */
/*if( $('.tablet-view').is(':visible') ){ // Tablet portrait code goes here

//----- END of TABLET PORTRAIT ONLY CODE -----//
}else{ // Everything EXCEPT tablet portrait code goes here

//----- END of NON-TABLET PORTRAIT CODE -----//
}//*/
/* --------------------------------------------------------------------------
    4.b DESKTOP CODE - Uncomment below if ever needed
   -------------------------------------------------------------------------- */
/*if( $('.desktop-view').is(':visible') ){ // Desktop only code goes here
//----- END of DESKTOP ONLY CODE -----//
}else{ // Everything EXCEPT desktop code goes here
//----- END of NON-DESKTOP CODE -----//
}//*/
//----- DO NOT ENTER CODE ON THE LINE BELOW -----//
odd++;if(odd % 2 === 0){init();}}init();setTimeout(function(){init();},150);$(window).resize(function(){init();if(typeof spacetime !== 'undefined'){clearTimeout(spacetime);} spacetime = setTimeout(function(){init();},600)});})})();(function($){
...
// Init slick on efficacy page (Clinical Trial Results)
$('.efficacy .slick').slick({
  slidesToShow: 1,
  centerMode: true,
  centerPadding: '0.25em',
  adaptiveHeight: true,
  dots: true,
  asNavFor: '.slick',
  mobileFirst: true,
...
// Init slick on HLA page
if($('.hla-slide').length) {
  $('.hla-slide').wrapAll('<div class="slick"></div>');
  $('.slick-prev').append('<img src="http://localhost:1313/images/carousel-left-arrows.svg" style="height: 50vh;">');
  if ($('.slick-initialized').length) {
    $('.slick').slick('unslick');
  }
}

$('.hla-screening .slick').slick({
  slidesToShow: 1,
  dots: true,
  adaptiveHeight: true,
  mobileFirst: false,
...
$(window).on("orientationchange",function(e){
  setTimeout(function() {
    ...
    if ($(window).width() > $(window).height()) {
      ...
      $('.header-offset').css('height', $('#header').height());
      if ($('.hla-screening .slick-initialized').length) {
        $('.slick').slick('unslick');
      }
